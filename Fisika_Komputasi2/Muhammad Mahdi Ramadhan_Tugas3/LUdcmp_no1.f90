		...
		nama_file_data="560489_data_matrix_ext.dat"
		...
		!melakukan penukaran baris matrix X
		...
		! Tampilkan matrix X sesudah melakukn pertukaran baris
		write(*,*) "Matrix X (sesudah melakukan pertukaran baris):"
		do i=1,N
			write(*,*) (X(i,j), j=1,M)
		end do
